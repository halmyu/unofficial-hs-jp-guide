...
範囲: Act 3, 963([https://homestuck.com/002863](https://homestuck.com/002863))-979([https://homestuck.com/002879](https://homestuck.com/002879))

1) 概要
- ジョンの父の部屋にあった[プレゼント](https://homestuck.com/story/963)を調べる。一つ目はモードコントロールデッキ（Modus Control Deck）とアレー（Array）モード、追加のカード。
- [アレーモード](https://homestuck.com/story/967)は任意のカードを取り出すことができる。モードコントロールデッキは取得モードの効果を[合成](https://homestuck.com/story/969)できる。
- Fruit Gushersを[よく見ると](https://homestuck.com/story/977)、憎きベティ・クロッカー社製だった。

2) 注記（用語・補足）
- アレー（Array）: 任意のカードを取り出すことができる
