...
範囲: Act 1, 148([https://homestuck.com/002048](https://homestuck.com/002048))-157([https://homestuck.com/002057](https://homestuck.com/002057))

1) 概要
- [部屋を拡張する](https://homestuck.com/story/148)には「[ビルドグリスト（Build Grist）](https://homestuck.com/story/153)」を消費する。[トーテム旋盤（Totem Lathe）](https://homestuck.com/story/151)をはじめとしたいくつかの装置は無料で配置できる。
- クライアントのみでは物の操作をすることはできない。TTはクライアントとサーバーを両方インストールしている。ジョンのところにもサーバーが届いているはずだ。

2) 注記（用語・補足）
- グリスト（Grist）: ゲーム内の資源
- トーテム旋盤（Totem Lathe）、Cruxtruder、Alchemiter: ゲーム内から現実に配置できる装置
