Act6 Act6 Intermission5-007 概要（原作と並読向け）

範囲: Act 6 Act 6 Intermission 5, 7497([https://homestuck.com/009397](https://homestuck.com/009397))-7498([https://homestuck.com/009398](https://homestuck.com/009398))

1) 概要
- 社交的な気分ではないジェイクはタヴロスと話すふりをする。ジェーンやダークとのトラブルを今解決することはできず、家族との再会を楽しんでいるロクシーの邪魔をするのは控えておく。そのロクシーの挨拶を受け、ぎこちない返事をする。タヴロスが自信をつけるアドバイスを語っているとヴリスカに止められる。

2) 注記（用語・補足）

3) 関連
- 前回: [[ACT6ACT6INTERMISSION5-002]]
- 次回: [[ACT6ACT6INTERMISSION5-008]]
