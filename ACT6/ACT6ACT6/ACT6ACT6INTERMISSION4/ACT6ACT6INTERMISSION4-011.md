Act6 Act6 Intermission4-011 概要（原作と並読向け）

範囲: Act 6 Act 6 Intermission 4, 7126([https://homestuck.com/009026](https://homestuck.com/009026))-7162([https://homestuck.com/009062](https://homestuck.com/009062))

1) 概要
- ミディアムに入る瞬間を変更するわけにはいかない。ザ・フェルトの屋敷で起きている出来事はよくわからない。
- デイブに気付かれる前に過去の自分を飛ばし、ロクシーを探しに行かせる。
- 特定の時点に戻るため、テレジが決めさせた思考の目印となるキーワードを思い出す。

2) 注記（用語・補足）

3) 関連
- 前回: [[ACT6ACT6INTERMISSION4-010]]
- 次回: [[ACT6ACT6INTERMISSION4-012]]
