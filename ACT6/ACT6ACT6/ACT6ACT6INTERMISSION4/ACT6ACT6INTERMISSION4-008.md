Act6 Act6 Intermission4-008 概要（原作と並読向け）

範囲: Act 6 Act 6 Intermission 4, 7084([https://homestuck.com/008984](https://homestuck.com/008984))-7099([https://homestuck.com/008999](https://homestuck.com/008999))

1) 概要
- 緑の大蛇を描くのを嫌がるカリオペの代わりに、ジェイドがテュポエウスの姿を描く。
- ジョンはテュポエウスの試練を受け、オイルから脱出する方法を探す。Retconの力で自分自身ではなくオイルを消し、本編のあらゆるところに散らした。星全体を覆っていたオイルを消したことで、雲を晴らす音楽を奏でることが可能になった。

2) 注記（用語・補足）

3) 関連
- 前回: [[ACT6ACT6INTERMISSION4-007]]
- 次回: [[ACT6ACT6INTERMISSION4-009]]
