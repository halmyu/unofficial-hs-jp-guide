Act6 Act6 Intermission1-002 概要（原作と並読向け）

範囲: Act 6 Act 6 Intermission 1, 6284([https://homestuck.com/008184](https://homestuck.com/008184))-6299([https://homestuck.com/008199](https://homestuck.com/008199))

1) 概要
- 女帝からロクシーに与えられた指令は、帝国の再生のためにマトリオーブを出現させることだった。無のローグとしての能力で、存在しないものの「無い状態」を奪って出現させることができるという。ロクシーは女帝に協力することを拒むが、飽きるまで殺すと脅されその能力を試す。力が不十分な場合は[完全汎用オブジェクト](https://homestuck.com/story/6295)が出現する。
- ジェイドはジョンを探しに行く。風で匂いがかき消されて簡単に捕らえることはできない。

2) 注記（用語・補足）

3) 関連
- 前回: [[ACT6ACT6INTERMISSION1-001]]
- 次回: [[ACT6ACT6INTERMISSION1-003]]（LOHAC）, [[ACT6ACT6INTERMISSION1-004]]（LOFAF）, [[ACT6ACT6INTERMISSION1-005]]（LOLAR）, [[ACT6ACT6INTERMISSION1-006]]（進む）
