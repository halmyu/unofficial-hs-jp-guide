Act6 Act6 Intermission1-008 概要（原作と並読向け）

範囲: Act 6 Act 6 Intermission 1, 6397([https://homestuck.com/008297](https://homestuck.com/008297))-6400([https://homestuck.com/008300](https://homestuck.com/008300))

1) 概要
- カーカットの命を利用されたことでカナヤは激昂し、寝返るつもりはないから今すぐ殺せばいいとジェーンを挑発する。ジェーンはそれを制し、ポーションを売りつけようとする。カナヤは虹飲みの欲求に抗えずトロールの血を購入する。

2) 注記（用語・補足）

3) 関連
- 前回: [[ACT6ACT6INTERMISSION1-007]]
- 次回: [[ACT6ACT6INTERMISSION1-009]]
