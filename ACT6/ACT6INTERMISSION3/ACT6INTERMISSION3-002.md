Act6 Intermission3-002 概要（原作と並読向け）

範囲: Act 6 Intermission 3, 5265([https://homestuck.com/007165](https://homestuck.com/007165))-5307([https://homestuck.com/007207](https://homestuck.com/007207))

1) 概要
- 艦内で迎えるジョンの二度目の誕生日。家でパーティーをし、Con Airを観ていたジョンは、これがかつて思っていた傑作ではないことに気付いて騒ぐ。
- デイブスプライトはパーティーに来ていない。彼とジェイドはつい最近破局していた。
- デイブスプライトが残した[父の書き置きのパロディ](https://homestuck.com/story/5297)でバカにされたジョンは、鬱憤を爆発させてふて寝をする。

2) 注記（用語・補足）

3) 関連
- 前回: [[ACT6INTERMISSION3-001]]
- 次回: [[ACT6INTERMISSION3-003]]
