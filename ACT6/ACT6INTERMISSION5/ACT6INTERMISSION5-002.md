Act6 Intermission5-002 概要（原作と並読向け）

範囲: Act 6 Intermission 5, 5939([https://homestuck.com/007839](https://homestuck.com/007839))

1) 概要
- 地球を脱出したカリボーンは新たなクエストを開始した。2つの星を征服して得た2人のレプラコーン（Leprechaun）の能力について著者にアドバイスを求める。1人目は速く、2人目は遅い。

2) 注記（用語・補足）
- レプラコーン（Leprechaun）: ザ・フェルトを構成する緑色の種族

3) 関連
- 前回: [[ACT6INTERMISSION5-001]]
- 次回: [[ACT6INTERMISSION5-003]]
