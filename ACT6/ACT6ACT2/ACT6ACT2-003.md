Act6 Act2-003 概要（原作と並読向け）

範囲: Act 6 Act 2, 4454([https://homestuck.com/006354](https://homestuck.com/006354))-4460([https://homestuck.com/006360](https://homestuck.com/006360))

1) 概要
- ラロンドが送ったアプリケーションはゲームをやめさせるために彼女が作った偽物だった。
- ストライダーはジェイクとジェーンの死をダースの新聞で知っている。ジェーンの塔は爆破されたが、遺体は見つからなかったという。ストライダーの夢体は現実に目覚めたまま動くことができ、ダースで隠密に活動している。ラロンドの夢体は眠ったまま外縁をさまよっている。
- 彼はクロッカー社の洗脳デバイスを使うべきではないという。セバスチャンを使って父のコンピューターにクライアントをインストールし、ストライダーがサーバーとして接続する。
