ACT6INTERMISSION4-005 概要（原作と並読向け）

範囲: Act 6 Intermission 4, 5497([https://homestuck.com/007397](https://homestuck.com/007397))-5511([https://homestuck.com/007411](https://homestuck.com/007411))

1) 概要
- 一人のプレイヤーで始めたこのセッションはデッドセッション（Dead session）と呼ばれ、最終的な報酬は宇宙を創り出すことではない。ヤルダバオートとの交渉によって真のクエストが始まり、それは極めて困難なものとなる。

2) 注記（用語・補足）
- デッドセッション（Dead session）: 単一のプレイヤーによるセッション

3) 関連
- 前回: [[ACT6INTERMISSION4-004]]
- 次回: [[ACT6ACT5ACT1-001]]
