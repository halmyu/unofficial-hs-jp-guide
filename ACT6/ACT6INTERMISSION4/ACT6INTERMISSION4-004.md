ACT6INTERMISSION4-004 概要（原作と並読向け）

範囲: Act 6 Intermission 4, 5492([https://homestuck.com/007392](https://homestuck.com/007392))-5496([https://homestuck.com/007396](https://homestuck.com/007396))

1) 概要
- 重要なものとされるバールの使い道を確かめる。
- 今いるこの星は人類が滅んでから長い時間を経た地球で、宇宙が崩壊する前に本来の太陽系から赤色超巨星の近くに移された。そしてカリボーンがゲームを始めた際にカーネルスプライトから変化したブラックホールに吸い込まれてミディアムに移動した。
- このセッションのあらゆるものは鍵がかかっており、鍵を探して解除していく必要がある。目的はデニゼンのヤルダバオート（Yaldabaoth）に会うこと。

2) 注記（用語・補足）
- ヤルダバオート（Yaldabaoth）: カリボーンのデニゼン

3) 関連
- 前回: [[ACT6INTERMISSION4-003]]
- 次回: [[ACT6INTERMISSION4-005]]
