Act6 Intermission1-002 概要（原作と並読向け）

範囲: Act 6 Intermission 1, 4336([https://homestuck.com/006236](https://homestuck.com/006236))-4345([https://homestuck.com/006245](https://homestuck.com/006245))

1) 概要
- ジェイドの能力で隕石に集合したローズとデイブ、トロールたちと合流することができるが、ジェイド自身は移動できない。直接会いに行く代わりに、[アルマゲドンのポスター](https://homestuck.com/story/4340)にメッセージを書いて送る。
- ジェイドが持ってきた5つの星の住人を呼び出す。戦場にいた[デイブスプライト](https://homestuck.com/story/4343)と一緒にメッセージを書く。

2) 注記（用語・補足）

3) 関連
- 前回: [[ACT6INTERMISSION1-001]]
- 次回: [[ACT6INTERMISSION1-003]]
